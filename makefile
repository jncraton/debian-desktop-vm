...
debian-12-text.img:
	virt-builder -v -x debian-12 --output $@ --format raw --root-password password:password --hostname aucs --firstboot-command 'useradd -m -p "" user' --install "build-essential,git,micro,sqlite3"
