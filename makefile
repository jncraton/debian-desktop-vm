...
debian-12-text.img:
	LIBGUESTFS_BACKEND=direct virt-builder -v -x debian-12 --output $@ --format raw --root-password password:password --hostname aucs --firstboot-command 'useradd -m -p "" user'
